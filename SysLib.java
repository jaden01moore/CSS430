...
public class SysLib {
    ...
    public static int open(String fileName, String mode)
    {
        ...
        temp[0] = fileName;
        temp[1] = mode;
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.OPEN, 0, temp);
    }
    ...
    public static int seek(int fd, int offset, int whence)
    {
        ...
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.SEEK, fd, temp);
    }
    ...
    public static int delete(int fd)
    {
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.DELETE, fd, null);
    }
